                    ...
                    @if ($pembimbing->perusahaan_id == $perusahaans->id)
                        <tr>
                            ...
                            <td class="flex gap-4">
                                <div>
                                    <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false"
                                        ...
                                        <button @click="modalOpen=true"
                                            class="btn btn-sm font-semibold bg-success hover:bg-success hover:scale-105 duration-300 px-5 text-white">Terima</button>
                                            ...
                                            <div x-show="modalOpen"
                                                ...
                                                <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                                                    ...
                                                    <div class="relative w-auto">
                                                        <form class="grid justify-center mb-12 mt-6 gap-y-2"
                                                            action="{{ route('perusahaan.terima-siswa', $pembimbing->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <input type="hidden" name="pembimbing_id"
                                                                value="{{ $pembimbing->id }}">
                                                            <label for="keterangan" class="text-start">Keterangan</label>
                                ...
                                <form action="{{ route('perusahaan.tolak-siswa', $pembimbing->id) }}" method="POST">
                                    @csrf
