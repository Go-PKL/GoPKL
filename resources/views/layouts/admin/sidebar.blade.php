{{-- <div class="flex flex-1">
    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#3C79F5]">
...
<div class="bg-primary">
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-side text-white ">
            ...
            <ul class="menu px-12 w-80 min-h-full">
                <!-- Sidebar content here -->
                <a class="flex justify-center items-center py-10" href="{{ route('VerifSiswa') }}">
                    <div>
                    ...
                    <li>
                        <details>
                            ...
                            <ul class="p-2 bg-base-100">
                                ...
                                <li><a href="{{ route('VerifSiswa') }}">Perusahaan</a></li>
                            </ul>
                        </details>
                    </li>
                    <li>
                        <div><i class="fas fa-users text-3xl"></i><a href="">Siswa</a></div>
                    </li>
                    <li>
                        <div><i class="fas fa-chalkboard-user text-3xl"></i><a>Guru</a></div>
                    </li>
                    <li>
                        <div><i class="fas fa-industry text-3xl"></i><a>Perusahaan</a></div>
                    </li>
                </div>
            </ul>
        </div>
